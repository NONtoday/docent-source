...
@Component({
    selector: 'dt-mentordashboard-gemiste-toetsen-popup',
    standalone: true,
    imports: [
        PopupComponent,
        IconDirective,
    ...
    templateUrl: './mentordashboard-gemiste-toetsen-popup.component.html',
    styleUrls: ['./mentordashboard-gemiste-toetsen-popup.component.scss'],
    providers: [provideIcons(IconDeeltoets, IconWeging, IconReacties)]
})
export class MentordashboardGemisteToetsenPopupComponent implements Popup {
